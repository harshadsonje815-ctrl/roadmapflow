...
export const DashboardPage: React.FC<DashboardPageProps> = ({
  ...
  const [currentView, setCurrentView] = useState<'feed' | 'roadmap'>(initialView);
  const [selectedRequestId, setSelectedRequestId] = useState<string | null>(null);
  const [isCreateOpen, setIsCreateOpen] = useState(false);
  const [adminTargetRequest, setAdminTargetRequest] = useState<FeatureRequest | null>(null);

  // Fetch paginated requests with current active Redux filters
